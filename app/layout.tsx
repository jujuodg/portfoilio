...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body
        className={`${inter.className} bg-gray-50 text-gray-950 relative pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`} //set the styles for dark mode
      >
